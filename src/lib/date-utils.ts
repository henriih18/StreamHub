 ...
 */
export function calculateExpirationDate(duration: string, startDate?: Date): Date {
 ...
 */
export function getExpirationStatus(expirationDate: Date, daysThreshold: number = 3) {
  const now = new Date()

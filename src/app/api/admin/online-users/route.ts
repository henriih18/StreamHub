...
export async function GET(request: NextRequest) {
  try {
    ...
    if (hour >= 19 && hour <= 22)
      peakMultiplier = 2.5; // Horario prime (7-10pm)
    else if (hour >= 12 && hour <= 14)
      peakMultiplier = 1.8; // Almuerzo (12-2pm)

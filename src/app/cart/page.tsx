                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-emerald-400 font-semibold">${item.price.toLocaleString('es-CO', { maximumFractionDigits: 0 })}</p>
                      </div>
              ...
              <Card className="bg-slate-900 border-slate-700 sticky top-24">
                ...
                <CardContent className="space-y-4">
                  <div className="flex justify-between text-slate-300">
                    <span>Subtotal</span>
                    <span>${getTotalPrice().toLocaleString('es-CO', { maximumFractionDigits: 0 })}</span>
                  </div>
                  <div className="flex justify-between text-slate-300">
                    <span>Envío</span>
